    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            if (jwtService.tokenValido(token) && SecurityContextHolder.getContext().getAuthentication() == null) {
                String email = jwtService.extrairClaims(token).get("email", String.class);
            ...
            // token invalido/expirado/malformado -> segue sem autenticar, o endpoint protegido vai barrar com 401/403
